...
namespace Nzl.Log4Net.Filter
{
	...
	/// event filtering. Note that <see cref="Nzl.Log4Net.Repository.Hierarchy.Logger"/> and 
	/// <see cref="Nzl.Log4Net.Appender.AppenderSkeleton"/>, the parent class of all standard
	...
	/// </para>
	/// <para>
	/// The philosophy of Nzl.Log4Net filters is largely inspired from the
	/// Linux ipchains.
	/// </para>
	/// </remarks>
