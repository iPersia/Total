...
namespace Nzl.Log4Net
{
	/// <summary>
	/// The Nzl.Log4Net Global Context.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// be included in the output of log messages. The <see cref="Nzl.Log4Net.Layout.PatternLayout"/>
	/// supports selecting and outputing these properties.
	/// </para>
	/// <para>
	/// By default the <c>Nzl.Log4Net:HostName</c> property is set to the name of 
	/// the current machine.
	/// </para>
	/// </remarks>
	/// <example>
	...
	public sealed class GlobalContext
	{
		...
		{
			Properties[Nzl.Log4Net.Core.LoggingEvent.HostNameProperty] = SystemInfo.HostName;
		}
