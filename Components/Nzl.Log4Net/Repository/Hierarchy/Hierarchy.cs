...
namespace Nzl.Log4Net.Repository.Hierarchy
{
	...
	public class Hierarchy : LoggerRepositorySkeleton, IBasicRepositoryConfigurator, IXmlRepositoryConfigurator
	{
		...
		/// using the <see cref="M:Nzl.Log4Net.LogManager.GetLogger(string)"/> method.
		/// </para>
		/// <para>
		...
		/// <remarks>
		/// <para>
		/// Returns all the <see cref="Nzl.Log4Net.Appender.IAppender"/> instances that are currently configured.
        ...
        /// <summary>
		/// Initialize the Nzl.Log4Net system using the specified appender
		/// </summary>
        ...
        /// <summary>
        /// Initialize the Nzl.Log4Net system using the specified appenders
        /// </summary>
		...
		/// <summary>
		/// Initialize the Nzl.Log4Net system using the specified config
		/// </summary>
