...
namespace Nzl.Log4Net.Config
{
	...
	/// specifies the type of the <see cref="Nzl.Log4Net.Repository.ILoggerRepository"/> object 
	...
	public /*sealed*/ class RepositoryAttribute : Attribute
	{
		...
		/// The type must implement the <see cref="Nzl.Log4Net.Repository.ILoggerRepository"/>
		/// interface.
		/// </para>
		/// <para>
