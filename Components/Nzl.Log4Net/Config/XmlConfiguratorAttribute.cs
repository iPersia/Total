...
namespace Nzl.Log4Net.Config
{
	...
	/// When using the Nzl.Log4Net assembly level attributes to control the configuration 
	/// of Nzl.Log4Net you must ensure that the first call to any of the 
	/// <see cref="Nzl.Log4Net.Core.LoggerManager"/> methods is made from the assembly with the configuration
	/// attributes. 
	/// </para>
	/// <para>
	/// If you cannot guarantee the order in which Nzl.Log4Net calls will be made from 
