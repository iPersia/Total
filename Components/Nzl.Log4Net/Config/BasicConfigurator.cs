...
using Nzl.Log4Net.Repository.Hierarchy;
...
namespace Nzl.Log4Net.Config
{
	...
	/// <remarks>
	/// <para>
	/// Allows very simple programmatic configuration of Nzl.Log4Net.
	/// </para>
	/// <para>
	...
	/// </para>
	/// <para>
	/// Appenders can also implement the <see cref="Nzl.Log4Net.Core.IOptionHandler"/> interface. Therefore
	/// they would require that the <see cref="M:Nzl.Log4Net.Core.IOptionHandler.ActivateOptions()"/> method
	...
	public sealed class BasicConfigurator
    {
		...
		/// <summary>
		/// Initializes the Nzl.Log4Net system with a default configuration.
		/// </summary>
		/// <remarks>
		/// <para>
		/// Initializes the Nzl.Log4Net logging system using a <see cref="ConsoleAppender"/>
	    ...
	    /// <summary>
		/// Initializes the Nzl.Log4Net system using the specified appender.
		/// </summary>
        ...
        /// <summary>
        /// Initializes the Nzl.Log4Net system using the specified appenders.
        /// </summary>
