...
using Nzl.Log4Net.Layout.Pattern;
using Nzl.Log4Net.Util;
using Nzl.Log4Net.Util.PatternStringConverters;
using AppDomainPatternConverter=Nzl.Log4Net.Layout.Pattern.AppDomainPatternConverter;
using DatePatternConverter=Nzl.Log4Net.Layout.Pattern.DatePatternConverter;
using IdentityPatternConverter=Nzl.Log4Net.Layout.Pattern.IdentityPatternConverter;
using PropertyPatternConverter=Nzl.Log4Net.Layout.Pattern.PropertyPatternConverter;
using UserNamePatternConverter=Nzl.Log4Net.Layout.Pattern.UserNamePatternConverter;
using UtcDatePatternConverter=Nzl.Log4Net.Layout.Pattern.UtcDatePatternConverter;

namespace Nzl.Log4Net.Layout
{
	/// <summary>
	...
	/// that the Nzl.Log4Net environment was set to use a PatternLayout. Then the
	/// statements
	/// </para>
	/// <code lang="C#">
	...
	/// 			assumed (<see cref="Nzl.Log4Net.DateFormatter.Iso8601DateFormatter"/>).
	/// 			</para>
	/// 			<para>
	...
	/// 			</para>
	/// 			<para>
	/// 			For better results it is recommended to use the Nzl.Log4Net date
	/// 			formatters. These can be specified using one of the strings
	/// 			"ABSOLUTE", "DATE" and "ISO8601" for specifying 
	/// 			<see cref="Nzl.Log4Net.DateFormatter.AbsoluteTimeDateFormatter"/>, 
	/// 			<see cref="Nzl.Log4Net.DateFormatter.DateTimeDateFormatter"/> and respectively 
	/// 			<see cref="Nzl.Log4Net.DateFormatter.Iso8601DateFormatter"/>. For example, 
	...
	/// 			the <c>Nzl.Log4Net:HostName</c> property is set to the name of machine on 
	...
	/// 			</para>
	/// 			<para>
	/// 			For example, for the class name "Nzl.Log4Net.Layout.PatternLayout", the
...
// SSCLI 1.0 has no support for ASP.NET
		...
		public void AddConverter(ConverterInfo converterInfo)
		{
            ...
            {
                throw new ArgumentException("The converter type specified [" + converterInfo.Type + "] must be a subclass of Nzl.Log4Net.Util.PatternConverter", "converterInfo");
            }
