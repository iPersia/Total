...
namespace Nzl.Log4Net.Layout
{
	...
	/// Nzl.Log4Net:event elements. It does not output a complete well-formed XML 
	...
	/// &lt;?xml version="1.0" ?&gt;
	/// 
	/// &lt;!DOCTYPE Nzl.Log4Net:events SYSTEM "Nzl.Log4Net-events.dtd" [&lt;!ENTITY data SYSTEM "abc"&gt;]&gt;
	///
	/// &lt;Nzl.Log4Net:events version="1.2" xmlns:Nzl.Log4Net="http://logging.apache.org/Nzl.Log4Net/schemas/Nzl.Log4Net-events-1.2&gt;
	///     &amp;data;
	/// &lt;/Nzl.Log4Net:events&gt;
	/// </code>
	/// <para>
	...
	public class XmlLayout : XmlLayoutBase
	{
		...
		/// <remarks>
		/// <para>
		/// The default prefix is <b>Nzl.Log4Net</b>. Set this property
