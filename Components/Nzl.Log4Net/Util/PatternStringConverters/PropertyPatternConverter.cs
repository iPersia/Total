...
namespace Nzl.Log4Net.Util.PatternStringConverters
{
	/// <summary>
	...
	internal sealed class PropertyPatternConverter : PatternConverter 
	{
		...
		/// should be set in the <see cref="Nzl.Log4Net.Util.PatternConverter.Option"/>
		/// property.
		/// </para>
		/// <para>
		/// If the <see cref="Nzl.Log4Net.Util.PatternConverter.Option"/> is set to <c>null</c>
