...
{
	/// <summary>
	/// Implementation of Stack for the <see cref="Nzl.Log4Net.ThreadContext"/>
	/// </summary>
	/// <remarks>
	/// <para>
	/// Implementation of Stack for the <see cref="Nzl.Log4Net.ThreadContext"/>
	...
	public sealed class ThreadContextStack : IFixingRequired
	{
		...
		/// for example by using the <c>using(Nzl.Log4Net.ThreadContext.Stacks["NDC"].Push("Stack_Message"))</c> 
		/// syntax.
		/// </para>
		/// </remarks>
		public void Clear() 
		...
		/// <code lang="C#">
		/// using(Nzl.Log4Net.ThreadContext.Stacks["NDC"].Push("Stack_Message"))
		/// {
