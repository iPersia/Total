...
namespace Nzl.Log4Net.Util
{
	...
	/// </para>
	/// <para>
	/// This class functions similarly to the <see cref="Nzl.Log4Net.Layout.PatternLayout"/>
	/// in that it accepts a pattern and renders it to a string. Unlike the 
	/// <see cref="Nzl.Log4Net.Layout.PatternLayout"/> however the <c>PatternString</c>
	...
	/// </para>
	/// <para>
	/// See the <see cref="Nzl.Log4Net.Layout.PatternLayout"/> for details on the 
