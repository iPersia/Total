...
namespace Nzl.Log4Net.Util.TypeConverters
{
	/// <summary>
	...
	public sealed class ConverterRegistry
	{
		...
		static ConverterRegistry()
		{
			...
			AddConverter(typeof(Nzl.Log4Net.Layout.PatternLayout), typeof(PatternLayoutConverter));
			AddConverter(typeof(Nzl.Log4Net.Util.PatternString), typeof(PatternStringConverter));
