...
namespace Nzl.Log4Net.Util
{
	...
	/// <summary>
	/// Outputs log statements from within the Nzl.Log4Net assembly.
	/// </summary>
	/// <remarks>
	/// <para>
	/// Log4net components cannot make Nzl.Log4Net logging calls. However, it is
	/// sometimes useful for the user to learn about what Nzl.Log4Net is
	/// doing.
	/// </para>
	/// <para>
	/// All Nzl.Log4Net internal debug calls go to the standard output stream
	...
	public sealed class LogLog
	{
		...
		/// <remarks>
		/// <para>
		/// The <c>Nzl.Log4Net.Internal.Debug</c> application setting
		/// controls internal debugging. This setting should be set
		/// to <c>true</c> to enable debugging.
		/// </para>
		/// <para>
		/// The <c>Nzl.Log4Net.Internal.Quiet</c> application setting
		...
		static LogLog()
		{
			...
			try
			{
				InternalDebugging = OptionConverter.ToBoolean(SystemInfo.GetAppSetting("Nzl.Log4Net.Internal.Debug"), false);
				QuietMode = OptionConverter.ToBoolean(SystemInfo.GetAppSetting("Nzl.Log4Net.Internal.Quiet"), false);
				EmitInternalMessages = OptionConverter.ToBoolean(SystemInfo.GetAppSetting("Nzl.Log4Net.Internal.Emit"), true);
			}
			catch(Exception ex)
			{
		...
		/// <summary>
		/// Gets or sets a value indicating whether Nzl.Log4Net internal logging
		/// is enabled or disabled.
		/// </summary>
		/// <value>
		/// <c>true</c> if Nzl.Log4Net internal logging is enabled, otherwise 
		/// <c>false</c>.
		/// </value>
		/// <remarks>
		/// <para>
		...
		/// <c>Nzl.Log4Net.Internal.Debug</c> in the application configuration
		/// file.
		/// </para>
		/// <para>
		...
		/// <summary>
		/// Gets or sets a value indicating whether Nzl.Log4Net should generate no output
		/// from internal logging, not even for errors. 
		/// </summary>
		/// <value>
		/// <c>true</c> if Nzl.Log4Net should generate no output at all from internal 
		...
		/// <c>Nzl.Log4Net.Internal.Quiet</c> in the application configuration file.
		/// </para>
		/// <para>
		...
		/// <configuration>
		///		<appSettings>
		///			<add key="Nzl.Log4Net.Internal.Quiet" value="true" />
		///		</appSettings>
		/// </configuration>
		/// </code>
		/// </example>
		...
		/// <summary>
		/// Writes Nzl.Log4Net internal debug messages to the 
		...
		/// <summary>
		/// Writes Nzl.Log4Net internal warning messages to the 
		...
		/// <summary>
		/// Writes Nzl.Log4Net internal error messages to the 
		/// standard error stream.
		/// </summary>
        /// <param name="source">The Type that generated this message.</param>
		/// <param name="message">The message to log.</param>
		...
		private const string PREFIX			= "Nzl.Log4Net: ";
		private const string ERR_PREFIX		= "Nzl.Log4Net:ERROR ";
		private const string WARN_PREFIX	= "Nzl.Log4Net:WARN ";
