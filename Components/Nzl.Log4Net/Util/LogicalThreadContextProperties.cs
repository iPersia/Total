...
{
	/// <summary>
	/// Implementation of Properties collection for the <see cref="Nzl.Log4Net.LogicalThreadContext"/>
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// <c>Nzl.Log4Net.Util.LogicalThreadContextProperties</c>.
	/// </para>
	/// <para>
	...
	{
		private const string c_SlotName = "Nzl.Log4Net.Util.LogicalThreadContextProperties";
