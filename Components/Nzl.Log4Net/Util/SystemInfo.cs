...
namespace Nzl.Log4Net.Util
{
	...
	public sealed class SystemInfo
	{
		...
		static SystemInfo()
		{
...
#if !NETCF
			// Look for Nzl.Log4Net.NullText in AppSettings
			string nullTextAppSettingsKey = SystemInfo.GetAppSetting("Nzl.Log4Net.NullText");
			...
			// Look for Nzl.Log4Net.NotAvailableText in AppSettings
			string notAvailableTextAppSettingsKey = SystemInfo.GetAppSetting("Nzl.Log4Net.NotAvailableText");
		...
		/// <remarks>
		/// <para>
		/// This is the time at which the Nzl.Log4Net library was loaded into the
		/// AppDomain. Due to reports of a hang in the call to <c>System.Diagnostics.Process.StartTime</c>
		/// this is not the start time for the current process.
		/// </para>
		/// <para>
		/// The Nzl.Log4Net library should be loaded by an application early during its
		...
		/// a value for the <c>Nzl.Log4Net.NullText</c> appSetting in the application's
		/// .config file.
		/// </para>
		/// </remarks>
		...
		/// a value for the <c>Nzl.Log4Net.NotAvailableText</c> appSetting in the application's
		/// .config file.
		/// </para>
		/// </remarks>
