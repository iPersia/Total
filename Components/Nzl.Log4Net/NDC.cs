...
#if NETCF_1_0
using Stack = Nzl.Log4Net.Util.ThreadContextStack.Stack;
#endif
...
namespace Nzl.Log4Net
{
	...
	public sealed class NDC
	{
		...
		/// <code lang="C#">
		/// using(Nzl.Log4Net.NDC.Push("NDC_Message"))
		/// {
		...
		public static void SetMaxDepth(int maxDepth) 
		{
			if (maxDepth >= 0)
			{
				Nzl.Log4Net.Util.ThreadContextStack stack = ThreadContext.Stacks["NDC"];
