...
namespace Nzl.Log4Net.Appender
{
	...
	public class AppenderCollection : ICollection, IList, IEnumerable, ICloneable
	{
		...
		private void ValidateIndex(int i, bool allowEqualEnd)
		{
			...
			if (i < 0 || i > max)
			{
				throw Nzl.Log4Net.Util.SystemInfo.CreateArgumentOutOfRangeException("i", (object)i, "Index was out of range. Must be non-negative and less than the size of the collection. [" + (object)i + "] Specified argument was out of the range of valid values.");
			}
		}
