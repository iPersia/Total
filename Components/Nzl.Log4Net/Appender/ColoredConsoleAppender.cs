...
#if !SSCLI
// We don't want framework or platform specific code in the CLI version of Nzl.Log4Net
#if !CLI_1_0
...
namespace Nzl.Log4Net.Appender
{
	...
	/// </code>
	/// <para>
	/// The Level is the standard Nzl.Log4Net logging level and ForeColor and BackColor can be any
	...
	public class ColoredConsoleAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// This method is called by the <see cref="M:AppenderSkeleton.DoAppend(Nzl.Log4Net.Core.LoggingEvent)"/> method.
		/// </summary>
        ...
        override protected void Append(Nzl.Log4Net.Core.LoggingEvent loggingEvent) 
		{
