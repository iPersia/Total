...
namespace Nzl.Log4Net.Appender 
{
	...
	/// <appender name="UdpAppender" type="Nzl.Log4Net.Appender.UdpAppender">
	///     <remoteAddress value="224.0.0.1" />
	///     <remotePort value="8080" />
	///     <layout type="Nzl.Log4Net.Layout.PatternLayout" value="%-5level %logger [%ndc] - %message%newline" />
	/// </appender>
	/// </code>
	/// </example>
	...
	public class UdpAppender : AppenderSkeleton
	{
		...
		public int RemotePort
		{
			...
			set 
			{
				...
				{
					throw Nzl.Log4Net.Util.SystemInfo.CreateArgumentOutOfRangeException("value", (object)value,
		...
		public override void ActivateOptions()
		{
			...
			{
				throw Nzl.Log4Net.Util.SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)this.RemotePort,
			...
			{
				throw Nzl.Log4Net.Util.SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)this.LocalPort,
