...
namespace Nzl.Log4Net.Appender
{
	...
	public class TextWriterAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="Nzl.Log4Net.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </summary>
		/// <value>
		/// The <see cref="Nzl.Log4Net.Util.QuietTextWriter"/> where logging events are written.
		/// </value>
		/// <remarks>
		/// <para>
		/// This is the <see cref="Nzl.Log4Net.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </para>
		/// </remarks>
