...
using Nzl.Log4Net.Layout;
using Nzl.Log4Net.Core;

namespace Nzl.Log4Net.Appender
{
	/// <summary>
	...
	/// <appender name="AdoNetAppender_SqlServer" type="Nzl.Log4Net.Appender.AdoNetAppender" >
	...
	///     <layout type="Nzl.Log4Net.Layout.PatternLayout" value="%date{yyyy'-'MM'-'dd HH':'mm':'ss'.'fff}" />
	///   </parameter>
	///   <parameter>
	///     <parameterName value="@thread" />
	///     <dbType value="String" />
	///     <size value="255" />
	///     <layout type="Nzl.Log4Net.Layout.PatternLayout" value="%thread" />
	///   </parameter>
	///   <parameter>
	///     <parameterName value="@log_level" />
	///     <dbType value="String" />
	///     <size value="50" />
	///     <layout type="Nzl.Log4Net.Layout.PatternLayout" value="%level" />
	///   </parameter>
	///   <parameter>
	///     <parameterName value="@logger" />
	///     <dbType value="String" />
	///     <size value="255" />
	///     <layout type="Nzl.Log4Net.Layout.PatternLayout" value="%logger" />
	///   </parameter>
	///   <parameter>
	///     <parameterName value="@message" />
	///     <dbType value="String" />
	///     <size value="4000" />
	///     <layout type="Nzl.Log4Net.Layout.PatternLayout" value="%message" />
	///   </parameter>
	/// </appender>
	/// </code>
	/// </example>
	...
	public class AdoNetAppender : BufferingAppenderSkeleton
	{
		...
		/// <code>"Driver={Microsoft Access Driver (*.mdb)};DBQ=C:\Work\cvs_root\Nzl.Log4Net-1.2\access.mdb;UID=;PWD=;"</code>
		/// </example>
		/// <example>Connection string for MS Access via OLE DB:
		/// <code>"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Work\cvs_root\Nzl.Log4Net-1.2\access.mdb;User Id=;Password=;"</code>
		/// </example>
