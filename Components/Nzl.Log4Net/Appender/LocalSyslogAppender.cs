...
namespace Nzl.Log4Net.Appender 
{
	...
	public class LocalSyslogAppender : AppenderSkeleton 
	{
		...
		/// <remarks>
		/// <para>
		/// The Nzl.Log4Net Level maps to a syslog severity using the
		...
		/// <summary>
		/// Translates a Nzl.Log4Net level to a syslog severity.
		/// </summary>
		/// <param name="level">A Nzl.Log4Net level.</param>
