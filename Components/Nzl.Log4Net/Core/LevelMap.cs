...
namespace Nzl.Log4Net.Core
{
	...
	/// This mapping is held separately for each <see cref="Nzl.Log4Net.Repository.ILoggerRepository"/>.
	...
	public sealed class LevelMap
	{
		...
		public void Add(string name, int value, string displayName)
		{
			...
			if (name.Length == 0)
			{
				throw Nzl.Log4Net.Util.SystemInfo.CreateArgumentOutOfRangeException("name", name, "Parameter: name, Value: ["+name+"] out of range. Level name must not be empty");
			}
