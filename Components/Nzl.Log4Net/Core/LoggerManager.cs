...
namespace Nzl.Log4Net.Core
{
	...
	/// </para>
	/// <para>
	/// This class is used by the wrapper managers (e.g. <see cref="Nzl.Log4Net.LogManager"/>)
	...
	/// the <see cref="RepositorySelector"/> property, or by setting the <c>Nzl.Log4Net.RepositorySelector</c>
	...
	public sealed class LoggerManager
	{
		...
		/// These are used to shutdown the Nzl.Log4Net system as the application exits.
		/// </para>
		/// </remarks>
		static LoggerManager()
		{
...
#if NETCF
			s_repositorySelector = new CompactRepositorySelector(typeof(Nzl.Log4Net.Repository.Hierarchy.Hierarchy));
#else

			// Look for the RepositorySelector type specified in the AppSettings 'Nzl.Log4Net.RepositorySelector'
			string appRepositorySelectorTypeName = SystemInfo.GetAppSetting("Nzl.Log4Net.RepositorySelector");
			...
			{
				s_repositorySelector = new DefaultRepositorySelector(typeof(Nzl.Log4Net.Repository.Hierarchy.Hierarchy));
			}
#endif
		}
		...
		/// <summary>
		/// Shuts down the Nzl.Log4Net system.
		/// </summary>
		/// <remarks>
		/// <para>
		...
		/// <see cref="Nzl.Log4Net.Repository.Hierarchy.Hierarchy"/> object.
		/// </para>
		/// <para>
		...
		private static string GetVersionInfo()
		{
			...
			// Build Up message
			sb.Append("Nzl.Log4Net assembly [").Append(myAssembly.FullName).Append("]. ");
		...
		/// </para>
		/// <para>
		/// When the event is triggered the Nzl.Log4Net system is <see cref="M:Shutdown()"/>.
		/// </para>
		/// </remarks>
