...
namespace Nzl.Log4Net.Core
{
	...
	/// </para>
	/// <para>
	/// The levels that are recognized by Nzl.Log4Net are set for each <see cref="Nzl.Log4Net.Repository.ILoggerRepository"/>
	/// and each repository can have different levels defined. The levels are stored
	/// in the <see cref="Nzl.Log4Net.Repository.ILoggerRepository.LevelMap"/> on the repository. Levels are
	/// looked up by name from the <see cref="Nzl.Log4Net.Repository.ILoggerRepository.LevelMap"/>.
	/// </para>
	/// <para>
	...
	sealed public class Level : IComparable
	{
        ...
        /// </summary>
        public readonly static Level Log4Net_Debug = new Level(120000, "Nzl.Log4Net:DEBUG");
