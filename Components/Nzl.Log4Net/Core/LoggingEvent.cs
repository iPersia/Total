...
namespace Nzl.Log4Net.Core
{
	...
	/// is passed around to the different Nzl.Log4Net components.
	/// </para>
	/// <para>
	/// This class is of concern to those wishing to extend Nzl.Log4Net.
	/// </para>
	/// <para>
...
#endif
	{
		...
		/// </para>
		/// <para>This method is called by the Nzl.Log4Net framework
		/// to create a logging event.
		/// </para>
		/// </remarks>
		public LoggingEvent(Type callerStackBoundaryDeclaringType, Nzl.Log4Net.Repository.ILoggerRepository repository, string loggerName, Level level, object message, Exception exception) 
		{
		...
		/// to be created independently of the Nzl.Log4Net framework. This can
		...
		/// </para>
		/// </remarks>
		public LoggingEvent(Type callerStackBoundaryDeclaringType, Nzl.Log4Net.Repository.ILoggerRepository repository, LoggingEventData data, FixFlags fixedData) 
		{
			m_callerStackBoundaryDeclaringType = callerStackBoundaryDeclaringType;
			m_repository = repository;
		...
		/// </para>
		/// </remarks>
		public LoggingEvent(Type callerStackBoundaryDeclaringType, Nzl.Log4Net.Repository.ILoggerRepository repository, LoggingEventData data) : this(callerStackBoundaryDeclaringType, repository, data, FixFlags.All)
		{
		}
		...
		/// <see cref="Nzl.Log4Net.Appender.IAppender.DoAppend"/> method call if this event 
		...
		/// </summary>
		public const string HostNameProperty = "Nzl.Log4Net:HostName";

		/// <summary>
		/// The key into the Properties map for the thread identity value.
		/// </summary>
		public const string IdentityProperty = "Nzl.Log4Net:Identity";

		/// <summary>
		/// The key into the Properties map for the user name value.
		/// </summary>
		public const string UserNameProperty = "Nzl.Log4Net:UserName";
