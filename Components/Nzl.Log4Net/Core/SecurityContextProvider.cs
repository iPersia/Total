...
namespace Nzl.Log4Net.Core
{
	...
	/// </para>
	/// <para>
	/// An alternative is to use the <c>Nzl.Log4Net.Config.SecurityContextProviderAttribute</c>
	/// This attribute can be applied to an assembly in the same way as the
	/// <c>Nzl.Log4Net.Config.XmlConfiguratorAttribute"</c>. The attribute takes
