...
namespace Nzl.Log4Net.Core
{
	...
	public class CompactRepositorySelector : IRepositorySelector
	{
		...
		public CompactRepositorySelector(Type defaultRepositoryType)
		{
			...
			{
				throw Nzl.Log4Net.Util.SystemInfo.CreateArgumentOutOfRangeException("defaultRepositoryType", (object)defaultRepositoryType, "Parameter: defaultRepositoryType, Value: ["+defaultRepositoryType+"] out of range. Argument must implement the ILoggerRepository interface");
			}
		...
		/// returned. The default repository is named <c>Nzl.Log4Net-default-repository</c>.
		/// </para>
		/// </remarks>
		...
		/// repository is <c>Nzl.Log4Net-default-repository</c>. Other repositories 
