...
namespace Nzl.Log4Net.Core
{
	...
	/// <see cref="Nzl.Log4Net.Appender.IAppender.DoAppend"/> method.
	/// </para>
	/// <para>
	/// When objects that implement this interface are stored 
	/// in the context properties maps <see cref="Nzl.Log4Net.GlobalContext"/>
	/// <see cref="Nzl.Log4Net.GlobalContext.Properties"/> and <see cref="Nzl.Log4Net.ThreadContext"/>
	/// <see cref="Nzl.Log4Net.ThreadContext.Properties"/> are fixed 
