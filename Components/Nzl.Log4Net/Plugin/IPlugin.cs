...
namespace Nzl.Log4Net.Plugin
{
	...
	/// with a <see cref="Nzl.Log4Net.Repository.ILoggerRepository"/>.
	/// The <see cref="PluginMap"/> held by the <see cref="Nzl.Log4Net.Repository.ILoggerRepository.PluginMap"/>
	/// property is used to store the plugins for a repository.
	/// </para>
	/// <para>
	/// The <c>Nzl.Log4Net.Config.PluginAttribute</c> can be used to
