...
using IRemoteLoggingSink = Nzl.Log4Net.Appender.RemotingAppender.IRemoteLoggingSink;

namespace Nzl.Log4Net.Plugin
{
	/// <summary>
	/// Plugin that listens for events from the <see cref="Nzl.Log4Net.Appender.RemotingAppender"/>
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// a remote <see cref="Nzl.Log4Net.Appender.RemotingAppender"/>.
	/// </para>
	/// <para>
