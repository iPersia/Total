namespace Nzl.Web.Pub.MobileNewSmth
{
    ...
    public partial class BoardForm : Form
    {
        ...
        private void BoardForm_MouseWheel(object sender, MouseEventArgs e)
        {
            try
            {
                if (this.panel.Height > this.splitContainer2.Panel1.Height)
                {
                    ...
                    yPos = yPos > margin ? margin : yPos;
                    yPos = yPos < this.splitContainer2.Panel1.Height - this.panel.Height - margin
                         ? this.splitContainer2.Panel1.Height - this.panel.Height - margin : yPos;
                    this.panel.Location = new Point(this.panel.Location.X, yPos);
                    if (yPos == this.splitContainer2.Panel1.Height - this.panel.Height - margin)
                    {
        ...
        private void bwFetchPage_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                if (this._uiContext != null)                               
                {
                    ...
                    {
                        this._uiContext.Post(UpdateLoginUser, "Unknown");
                        this._uiContext.Post(UpdateBoardTitle, wp);
                        this._uiContext.Post(UpdatePageInfo, wp);
                        this._uiContext.Post(UpdateLogInStatus, wp);
        ...
        /// </summary>
        /// <param name="wp"></param>
        private void UpdateBoardTitle(object state)
        {
        ...
        /// <param name="page"></param>
        /// <returns></returns>
        private void UpdatePageInfo(object state)
        {
